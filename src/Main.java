public class Main {
    public static void main(String[] args) {
        ...
        Cars Lada = new Cars("Lada","Granta", 1.7,BodyType.SEDAN);
        System.out.println(Lada);
        Lada.pitStop();
        Lada.bestLapTime();
        Lada.maxSpeed();
        Cars Audi = new Cars("Audi","A8", 2.8,BodyType.SEDAN);
        System.out.println(Audi);
        Cars BMW = new Cars("BMW","Z8", 3.0,BodyType.SEDAN);
        System.out.println(BMW);
        Cars KIA = new Cars("KIA","Sportage", 2.4,BodyType.CROSSOVER);
